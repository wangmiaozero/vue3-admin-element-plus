...
import { getLocalImg } from "@/utils/tool";
import { useI18n } from "vue-i18n";
const { t } = useI18n();
const avatar = ref(getLocalImg("avatar"));
const userName = ref("seedling");
...
const handleCommand = (command) => {
  switch (command) {
    case "logout":
      ...
      break;
    case "github":
      window.open("https://github.com/seedling/vue3-admin-element-template");
      break;
    default:
      break;
  }
